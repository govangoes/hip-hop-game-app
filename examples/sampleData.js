...
exports.sampleEvent = exports.sampleAlbums = exports.samplePacks = exports.sampleItems = void 0;
const enums_1 = require("../src/types/enums");
const dropRates_1 = require("../src/config/dropRates");
/**
...
exports.sampleItems = [
    // Legendary Artists
    {
        ...
        category: enums_1.CollectibleCategory.ARTIST,
        rarity: enums_1.RarityTier.LEGENDARY,
    ...
    // Epic Albums
    {
        ...
        category: enums_1.CollectibleCategory.ALBUM,
        rarity: enums_1.RarityTier.EPIC,
    ...
    // Rare Venues
    {
        ...
        category: enums_1.CollectibleCategory.VENUE,
        rarity: enums_1.RarityTier.RARE,
    ...
    // Common Cultural Icons
    {
        ...
        category: enums_1.CollectibleCategory.CULTURAL_ICON,
        rarity: enums_1.RarityTier.COMMON,
...
exports.samplePacks = [
    {
        ...
        cost: 100,
        currencyType: enums_1.CurrencyType.SOFT,
        guaranteedItemCount: 3,
        possibleItems: exports.sampleItems.map(item => item.id),
        dropRates: dropRates_1.DEFAULT_DROP_RATES,
        isActive: true,
        createdAt: new Date('2025-01-01')
    },
    {
        ...
        cost: 500,
        currencyType: enums_1.CurrencyType.PREMIUM,
        guaranteedItemCount: 5,
        possibleItems: exports.sampleItems.map(item => item.id),
        dropRates: dropRates_1.PREMIUM_DROP_RATES,
        isActive: true,
        createdAt: new Date('2025-01-01')
    },
    {
        ...
        possibleItems: exports.sampleItems
...
exports.sampleEvent = {
    ...
    eventType: enums_1.EventType.SEASONAL,
